...
/**
 * Provides the local service interface for ADDFILE. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ADDFILELocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ADDFILELocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>BoardService.service.impl.ADDFILELocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the addfile local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ADDFILELocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ADDFILE addADDFILE(ADDFILE addfile);
	...
	public ADDFILE createADDFILE(long fno);
	...
	public ADDFILE deleteADDFILE(ADDFILE addfile);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ADDFILE deleteADDFILE(long fno) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ADDFILE fetchADDFILE(long fno);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ADDFILE getADDFILE(long fno) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ADDFILE> getADDFILEs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ADDFILE updateADDFILE(ADDFILE addfile);
