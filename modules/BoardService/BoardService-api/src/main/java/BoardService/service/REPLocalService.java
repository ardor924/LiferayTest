...
/**
 * Provides the local service interface for REP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see REPLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface REPLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>BoardService.service.impl.REPLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the rep local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link REPLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public REP deleteREP(long rno) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<REP> getREPs(int start, int end);
