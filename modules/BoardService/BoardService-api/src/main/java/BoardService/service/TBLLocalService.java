...
/**
 * Provides the local service interface for TBL. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TBLLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TBLLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>BoardService.service.impl.TBLLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the tbl local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TBLLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TBL> getTBLListByContents(
		String searchKeyword, int cntPerPage, int initRowNumber);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TBL> getTBLListBySearch(
		String searchKeyword, String option, int cntPerPage, int initRowNumber);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TBL> getTBLListBySuebject(
		String searchKeyword, int cntPerPage, int initRowNumber);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TBL> getTBLListByWriter(
		String searchKeyword, int cntPerPage, int initRowNumber);
