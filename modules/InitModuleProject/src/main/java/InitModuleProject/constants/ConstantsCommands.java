package InitModuleProject.constants;

public class ConstantsCommands {
	
	public static final String HHLBOARD_CREATE_PROJECT_RENDER ="hhl/project/create/render";
	public static final String HHLBOARD_CREATE_PROJECT_ACTION ="hhl/project/create/action";
	
	// List호출
	public static final String HHLBOARD_LIST_PROJECT ="hhl/project/list";
	
	// CRUD
	public static final String HHLBOARD_WRITE_PROJECT ="hhl/project/write";
	public static final String HHLBOARD_VIEW_PROJECT ="hhl/project/view";
